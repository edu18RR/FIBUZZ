...
console.log("Conteo de Explorers en node:" + explorersInNode.length) // Conteo de explorers del archivo .JSON

// Part4: Get the explorer's usernames in Node
const explorersInNodeToGetUsernames = explorers.filter((explorer) => explorer.mission == "node");
const usernamesInNode = explorersInNodeToGetUsernames.map((explorer) => explorer.githubUsername);
console.log(usernamesInNode) // muestra los usuarios de github con el .map
...
console.log(explorersInNodeAndFizzTrick) // toma el valor score y lo dive en /3
